...
urlpatterns = patterns('discussion.views',
                           ...
                           url(r'^conversations/(?P<pseudo_utilisateur>\w+)/creation_conversation$','creation_conversation'),
                            url(r'^conversations/(?P<pseudo_utilisateur>\w+)/creation_nouvelle_conversation$','creation_nouvelle_conversation'),
			               ...
			               url(r'^conversations/(?P<pseudo_utilisateur>\w+)/(?P<id_conversation>\d+)$', 'conversation'),
                           url(r'^conversations/(?P<pseudo_utilisateur>\w+)/ajout_ami_creation_conversation$', 'ajout_ami_creation_conversation'), 
                       )
