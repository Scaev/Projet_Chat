...
urlpatterns = patterns('discussion.views',
			   ...
			   url(r'^conversations/(?P<pseudo_utilisateur>\w+)/(?P<id_conversation>\d+)/envoiMessage$', 'envoiMessage'),
			   url(r'^conversations/(?P<pseudo_utilisateur>\w+)/(?P<id_conversation>\d+)/affichageMessage$', 'affichageMessage'),
